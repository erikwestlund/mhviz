...
sr <- summarize_design(sr_formula, plot_height = 6)
m <- summarize_design(m_formula, plot_height = 6)
i <- summarize_design(i_formula, plot_height = 6)
ce <- summarize_design(ce_formula, plot_height = 6)
...
## Provider Quality
![](images/provider_quality_dag_plot.png)

### Willingness to Pay
![](images/willingness_to_pay_dag_plot.png)

## Personal Capacity

![](images/personal_capacity_dag_plot.png)

## Provider Trust
![](images/provider_trust_dag_plot.png)

## Risk Aversion
![](images/risk_aversion_dag_plot.png)

## Risk Profile
![](images/risk_profile_dag_plot.png)

## Political/Economic Conditions
![](images/political_economic_conditions_dag_plot.png)

## Dependents
![](images/dependents_dag_plot.png)

## Job Type
![](images/job_type_dag_plot.png)

## Distance to Provider
![](images/distance_to_provider_miles_dag_plot.png)

## Income
![](images/income_dag_plot.png)

## Insurance
![](images/insurance_dag_plot.png)

## Cultural Orientation
![](images/cultural_orientation_dag_plot.png)

## Parental Income
![](images/parent_income_dag_plot.png)

## Educational Attainment
![](images/educational_attainment_dag_plot.png)

## Self-reliance 
![](images/self-reliance_dag_plot.png)

## Motivation
![](images/motivation_dag_plot.png)

## Intelligence
![](images/intelligence_dag_plot.png)

## Community Engagement
![](images/community_engagement_dag_plot.png)

## Religion
![](images/religion_dag_plot.png)
